...
import { Mic, Keyboard, Globe, Sparkles, Zap, Shield, Download, ChevronRight, Volume2, Type, Settings, Waves } from 'lucide-react';
    ...
    <main>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <div className="animate-fade-in-up animate-delay-4 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="#download" className="group flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[var(--color-gold-bright)] to-[var(--color-gold)] text-[var(--color-ink)] font-bold rounded-xl text-lg transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(201,168,76,0.3)]"
              style={{ animation: 'pulse-gold 3s ease-in-out infinite' }}>
              <Download className="w-5 h-5" />
              Download Free
              <ChevronRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </a>
            <span className="text-sm text-[var(--color-muted)]">Windows 10/11 &middot; 105 MB &middot; No account needed</span>
          </div>
        </div>
      ...
      <section id="download" className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-5xl md:text-6xl font-black mb-6" style={{ fontFamily: 'Cabinet Grotesk, Satoshi, sans-serif' }}>
            Ready to stop typing?
          </h2>
          <p className="text-xl text-[var(--color-muted)] mb-10 leading-relaxed">
            Download VoiceInk. Install in one click. Start speaking in 30 seconds.
          </p>

          <a href="https://github.com/Nisse-hash/voice-input-button/releases/latest" className="group inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-[var(--color-gold-bright)] to-[var(--color-gold)] text-[var(--color-ink)] font-bold rounded-xl text-xl transition-all hover:scale-105 hover:shadow-[0_0_60px_rgba(201,168,76,0.3)]">
          ...
          <p className="mt-6 text-sm text-[var(--color-muted)]">
            Free forever &middot; No account &middot; No data collection &middot; macOS coming soon
          </p>
        </div>
      </section>
